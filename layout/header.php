<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from Comtinuum Capital Trading.com/en/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2023 17:26:30 GMT -->
<!-- Added by HTTrack -->
<!-- Mirrored from Comtinuum Capital Trading.com/en/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Nov 2023 11:36:18 GMT -->
...
<head>
    <!-- metas -->
    <meta charset="utf-8">
    <meta name="author" content="Comtinuum Capital Trading COMPANY" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <meta name="keywords" content="investment, crypto trading, cryptocurrencies, bitcoin, blockcahin" />
    <meta name="description" content="We Provide
        CUSTOMIZED INVESTMENT OPTIONS
        Get investment portfolio tailored to meet you specific financial objectives" />
    <!-- title  -->
    <title>Comtinuum Capital Trading | Blockchain-driven Investment Options</title>
    <!-- favicon -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-xs-12">
                        <ul class="top-social-icon">
                            <a href='https://panel.comtinuumcapitaltrading.com/login' class='butn theme'><span>Login</span></a>
                        </ul>
                        <ul class="top-social-icon">
                            <a href='#' class='butn1'>.<span></span></a>
                        </ul>
                        <ul class="top-social-icon">
                            <a href='https://panel.comtinuumcapitaltrading.com/register' class='butn theme'><span>Sign Up</span></a>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="menu_area alt-font">
                                <nav class="navbar navbar-expand-lg navbar-light no-padding">
                                    <div class="navbar-header navbar-header-custom">
                                        <!-- start logo -->
                                        <!-- <a href="index-2.html" class="navbar-brand"><img id="logo" src="img/logos/Comtinuum Capital Trading.png" alt="logo" style="transform: scale(2); "></a> -->
                                        <!-- end logo -->
                                    </div>
                                    ...
                                    <ul class="navbar-nav ml-auto" id="nav" style="display: none;">
                                        ...
                                        <li><a href="investment.php">Investment Services</a></li>
